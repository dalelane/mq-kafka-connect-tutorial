...
echo "--------------------------"
echo "Installing the MQ Operator"
echo "--------------------------"
...
echo "> install the MQ operator"
oc apply -f ./resources/subscription.yaml

echo "> wait for the MQ operator install plan to be created"
INSTALL_PLAN=""
...
echo "> wait for the MQ operator install plan to complete"
